...
MobX will not be able to automatically track changes to the object's properties. Should you need change tracking at the field level, its better to mark them with the `@observable` annotation.
