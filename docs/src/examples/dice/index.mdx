...
- `total` is a computed observable annotated with `@computed` this is my favourite feature in Mobx. Computed observables are in-sync everytime left or right count is updated. It is incredibly useful as I can access this value as part of the initial state when the instance of the store is created without any 

## Connecting the Store with the View
