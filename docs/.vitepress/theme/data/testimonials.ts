...
export const testimonials: TestimonialContent[] = [
  {
    ...
    photoUrl: '/images/people/remi.jpg',
  ...
  },
  {
    ...
    photoUrl: '/images/people/chris.png',
    message: `If you haven\'t seen MobX.dart, check it out. In combination with Provider, it\'s PFM (Pure Flutter Magic). I use it when I build anything real. #recommended #Flutter`,
  },
  {
    author: 'Aloïs Deniel',
    ...
    photoUrl: '/images/people/alois.jpg',
...
I highly recommend it ! 👌`,
  },
  {
    ...
    photoUrl: '/images/people/robert.jpg',
...
MobX supports me on all of my projects.`,
  },
  {
    ...
    photoUrl: '/images/people/jacob.jpg',
...
Several people here in Brazil are building Flutter apps quickly, thanks to MobX.`,
  },
  {
    ...
    photoUrl: '/images/people/michael.jpg',
  ...
  },
  {
    ...
    photoUrl: '/images/people/sanket.jpg',
    message:
