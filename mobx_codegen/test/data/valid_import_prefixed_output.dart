mixin _$User<T extends io.Process> on UserBase<T>, Store {
  ...
  @override
  io.File? get biographyNotesNullable =>
  ...
  late final _$biographyNullableAtom = Atom(
    name: 'UserBase.biographyNullable',
    context: context,
  );
  ...
  late final _$friendWithImplicitTypeArgumentAtom = Atom(
    name: 'UserBase.friendWithImplicitTypeArgument',
    context: context,
  );
  ...
  set friendWithImplicitTypeArgument(User<io.Process> value) {
    _$friendWithImplicitTypeArgumentAtom.reportWrite(
      value,
      super.friendWithImplicitTypeArgument,
      () {
  ...
  set friendWithImplicitTypeArgumentNullable(User<io.Process>? value) {
    _$friendWithImplicitTypeArgumentNullableAtom.reportWrite(
      value,
      super.friendWithImplicitTypeArgumentNullable,
      () {
  ...
  late final _$friendWithExplicitTypeArgumentAtom = Atom(
    name: 'UserBase.friendWithExplicitTypeArgument',
    context: context,
  );
  ...
  set friendWithExplicitTypeArgument(User<T> value) {
    _$friendWithExplicitTypeArgumentAtom.reportWrite(
      value,
      super.friendWithExplicitTypeArgument,
      () {
  ...
  set friendWithExplicitTypeArgumentNullable(User<T>? value) {
    _$friendWithExplicitTypeArgumentNullableAtom.reportWrite(
      value,
      super.friendWithExplicitTypeArgumentNullable,
      () {
  ...
  late final _$callbackNullableAtom = Atom(
    name: 'UserBase.callbackNullable',
    context: context,
  );
  ...
  late final _$callback2NullableAtom = Atom(
    name: 'UserBase.callback2Nullable',
    context: context,
  );
  ...
  late final _$localTypedefCallbackAtom = Atom(
    name: 'UserBase.localTypedefCallback',
    context: context,
  );
  ...
  set localTypedefCallback(ValueCallback<io.Process> value) {
    _$localTypedefCallbackAtom.reportWrite(
      value,
      super.localTypedefCallback,
      () {
  ...
  late final _$localTypedefCallbackNullableAtom = Atom(
    name: 'UserBase.localTypedefCallbackNullable',
    context: context,
  );
  ...
  set localTypedefCallbackNullable(ValueCallback<io.Process?> value) {
    _$localTypedefCallbackNullableAtom.reportWrite(
      value,
      super.localTypedefCallbackNullable,
      () {
  ...
  late final _$prefixedTypedefCallbackAtom = Atom(
    name: 'UserBase.prefixedTypedefCallback',
    context: context,
  );
  ...
  set prefixedTypedefCallback(io.BadCertificateCallback value) {
    _$prefixedTypedefCallbackAtom.reportWrite(
      value,
      super.prefixedTypedefCallback,
      () {
  ...
  late final _$prefixedTypedefCallbackNullableAtom = Atom(
    name: 'UserBase.prefixedTypedefCallbackNullable',
    context: context,
  );
  ...
  set prefixedTypedefCallbackNullable(io.BadCertificateCallback? value) {
    _$prefixedTypedefCallbackNullableAtom.reportWrite(
      value,
      super.prefixedTypedefCallbackNullable,
      () {
  ...
  @override
  ObservableStream<T> loadDirectory<T extends io.Directory>(
    String arg1, {
    T directory,
  }) {
  ...
  late final _$UserBaseActionController = ActionController(
    name: 'UserBase',
    context: context,
  );
