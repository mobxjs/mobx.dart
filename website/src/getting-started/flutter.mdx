...
import endResult from "./end_result.png";

# Getting Started

For this tutorial, we will start with a slightly modified version of the example created from `flutter create`. Once you generate a project, here's what you get inside `lib/main.dart`:
